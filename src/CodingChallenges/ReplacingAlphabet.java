...
public class ReplacingAlphabet {
    ...
    public static void replaceAlphabetString(String str) {
        ...
        char [] strCharArr = strLower.toCharArray();
        StringBuilder sb = new StringBuilder();

        for (Character c : strCharArr) {
    ...
    public static void replaceAlphabetSentence(String str) {
        String strLower = str.toLowerCase();
